        ...
        <igc-nav-drawer ?open="${true}" position="relative" id="nav-drawer" class="nav-drawer">
          <igc-list class="list">
            <igc-list-item @click="${() => Router.go('/home')}">
              <igc-avatar src="/src/assets/Home-Avatar-Icon.svg" FontSet="Material" slot="start" shape="circle" class="avatar"></igc-avatar>
              <div slot="title">Home</div>
            </igc-list-item>
            <igc-list-item @click="${() => Router.go('/accounts')}">
              <igc-avatar src="/src/assets/Accounts-Avatar-Icon.svg" FontSet="Material" slot="start" shape="circle" class="avatar"></igc-avatar>
              <div slot="title">Accounts</div>
            </igc-list-item>
            <igc-list-item @click="${() => Router.go('/contacts')}">
              <igc-avatar src="/src/assets/Contacts-Avatar-Icon.svg" FontSet="Material" slot="start" shape="circle" class="avatar"></igc-avatar>
              <div slot="title">Contacts</div>
            </igc-list-item>
            <igc-list-item @click="${() => Router.go('/contracts')}">
              <igc-avatar src="/src/assets/Contracts-Avatar-Icon.svg" FontSet="Material" slot="start" shape="circle" class="avatar"></igc-avatar>
              <div slot="title">Contracts</div>
            </igc-list-item>
            <igc-list-item @click="${() => Router.go('/reports')}">
              <igc-avatar src="/src/assets/Reports-Avatar-Icon.svg" FontSet="Material" slot="start" shape="circle" class="avatar"></igc-avatar>
              <div slot="title">Reports</div>
            </igc-list-item>
            <igc-list-item @click="${() => Router.go('/calendar')}">
              <igc-avatar src="/src/assets/Calendar-Avatar-Icon.svg" FontSet="Material" slot="start" shape="circle" class="avatar"></igc-avatar>
              <div slot="title">Calendar</div>
            </igc-list-item>
            <igc-list-item @click="${() => Router.go('/tasks')}">
              <igc-avatar src="/src/assets/Tasks-Avatar-Icon.svg" FontSet="Material" slot="start" shape="circle" class="avatar"></igc-avatar>
