            ...
            <igc-tab-panel class="column-layout tab-item-content">
              ...
              <igc-accordion ?single-expand="${true}" class="accordion">
                <igc-expansion-panel indicator-position="end">
                  <div class="column-layout group_9">
                    <div class="row-layout group_10">
                      <igc-avatar initials="JL" FontSet="Material" shape="circle" class="avatar"></igc-avatar>
                ...
                <igc-expansion-panel indicator-position="end">
                  <div class="column-layout group_9">
                    <div class="row-layout group_10">
                      <igc-avatar src="/src/assets/Account-List-Avatar-Icon.svg" shape="rounded" FontSet="Material" class="avatar_1"></igc-avatar>
                      <a href="" class="typography__body-2 hyperlink">
                        Around The Horn
                      </a>
                    </div>
                ...
                <igc-expansion-panel indicator-position="end">
                  <igc-list class="list">
                    <igc-list-item>
                      <igc-avatar FontSet="Material" slot="start" shape="circle" class="avatar_2">
                    ...
                    <igc-list-item>
                      <igc-avatar FontSet="Material" slot="start" shape="circle" class="avatar_3">
                        <span class="material-icons">insert_drive_file</span>
                      </igc-avatar>
                      <div>
                        <a href="" class="typography__body-2 hyperlink_1">
              ...
              <div class="column-layout group_15">
                ...
                <igc-accordion ?single-expand="${true}" class="accordion">
                  <igc-expansion-panel indicator-position="end">
                    <igc-list class="list">
                      <igc-list-item>
                        <igc-avatar src="/src/assets/Calendar-Avatar-Icon.svg" FontSet="Material" slot="start" class="avatar_4"></igc-avatar>
                        <div>
                      ...
                      <igc-list-item>
                        <igc-avatar src="/src/assets/Calendar-Avatar-Icon.svg" FontSet="Material" slot="start" class="avatar_5"></igc-avatar>
                        <div>
                          <div class="column-layout group_16">
                            <div class="row-layout group_17">
                              <p class="typography__subtitle-2 text_5">
                      ...
                      <igc-list-item>
                        <igc-avatar src="/src/assets/Calendar-Avatar-Icon.svg" FontSet="Material" slot="start" class="avatar_6"></igc-avatar>
                        <div>
                          <div class="column-layout group_16">
                            <div class="row-layout group_17">
                              <p class="typography__subtitle-2 text_5">
