...
import { CustomersType } from '../static-data/northwind-model';
import { RevenueType } from '../static-data/ecommerce-model';
import { MeetingsTasksType } from '../static-data/crmapp-data-model';
import ECommerceService from '../service/ECommerce-service';
import CRMAppDataService from '../service/CRMAppData-service';
            ...
            <div class="column-layout group_6">
              <igc-list class="list">
                ${this.northwindCustomers?.map((item) => html`
                  <igc-list-item>
                    <igc-avatar src="/src/assets/Account-List-Avatar-Icon.svg" shape="rounded" FontSet="Material" slot="start" class="avatar"></igc-avatar>
                    <div>
          ...
          <div class="column-layout group_5">
            ...
            <div class="column-layout group_6">
              <igc-list class="list">
                ${this.northwindCustomers?.map((item) => html`
                  <igc-list-item>
                    <igc-avatar src="/src/assets/Contacts-List-Avatar-Icon.svg" FontSet="Material" slot="start" shape="circle" class="avatar_1"></igc-avatar>
                    <div>
                      <div class="column-layout group_7">
        ...
        <div class="column-layout group_4">
          <div class="column-layout group_3">
            ...
            <igc-list class="list">
              ${this.cRMAppDataMeetingsTasks?.map((item) => html`
                <igc-list-item>
                  <igc-avatar src="/src/assets/Calendar-Avatar-Icon.svg" FontSet="Material" slot="start" class="avatar_2"></igc-avatar>
                  <div>
                    <div class="column-layout group_7">
          ...
          <div class="column-layout group_3">
            ...
            <igc-list class="list">
              ${this.cRMAppDataMeetingsTasks?.map((item) => html`
                <igc-list-item>
                  <igc-avatar src="/src/assets/Tasks-Avatar-Icon.svg" FontSet="Material" slot="start" class="avatar_3"></igc-avatar>
                  <div>
                    <div class="column-layout group_7">
